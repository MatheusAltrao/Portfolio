const projects = [
  ...
  },
  {
    ...
    image:
      "https://i.pinimg.com/736x/73/da/01/73da01536e795d72207a46f692aa4983.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/01/d9/dd/01d9dd109d9707391844312273e85bca.jpg",
...

  {
    ...
    image:
      "https://assets.codante.io/challenge-screenshots/hackathon-do-carnaval-de-2025-103171495-NohtIUpsru.webp",
...

  {
    name: "Kerdos",
    description:
      "SASS de controle financeiro, com gráficos e relatórios para melhor visualização.",
    image:
      "https://i.pinimg.com/originals/2c/1d/27/2c1d2765695234ee48c45809ed033bc1.png",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/88/1c/a0/881ca02973a0bb6e594a9538bb2cf9b3.jpg",
...

  {
    name: "Blog",
    description:
      "Conheça mais sobre mim, conto um pouco  do meu dia a dia e posto lá. ",
    image:
      "https://i.pinimg.com/originals/69/80/f7/6980f7af3e36d70c7b3b6d92d5cdbfc8.jpg",
...

  {
    name: "TaskList",
    description:
      "Organize melhor o seu dia, listagem de tarefas e compartilhe com os seus amigos.",
    image:
      "https://i.pinimg.com/originals/ad/d3/04/add3043a92810d64512576232b67e32a.jpg",
...

  {
    name: "Games",
    description:
      "Procure os seus games preferidos e veja muitas informações sobre ele.",
    image:
      "https://games-indol-five.vercel.app/_next/image?url=https%3A%2F%2Fsujeitoprogramador.com%2Fnext-api%2Ffoto14.png&w=1920&q=100",
...

  {
    ...
    image:
      "https://i.pinimg.com/originals/13/52/b3/1352b36cbf7f5db50bcc6ab2726d205e.jpg",
  ...
  },
  {
    name: "Ui Notion",
    description:
      "Usando uma lib de editor de texto para simular funcionalidades do notion.",
    image:
      "https://i.pinimg.com/originals/88/dc/1f/88dc1f6b1499ff436354c1fdf11f3f84.png",
 ...
 */
  {
    ...
    description:
      "LandingPage para consultórios médicos, simples e direta ao ponto.",
    image:
      "https://myportfolio-omega-nine.vercel.app/assets/assistenciamedica-ea4c928d.png",
...

  {
    ...
    image:
      "https://myportfolio-omega-nine.vercel.app/assets/salaodebeleza-5a49862d.png",
